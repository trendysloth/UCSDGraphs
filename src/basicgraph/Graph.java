...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (Integer i = 0; i < this.getNumVertices(); i++) {
			Integer numOfInDegrees = this.getInNeighbors(i).size();
			Integer numOfOutDegrees = this.getNeighbors(i).size();
			Integer totalDegrees = numOfInDegrees + numOfOutDegrees;
			degrees.add(totalDegrees);
		}
